...
class SettingsSection extends window.DI.React.Component {
    ...
    get h2Class() {
        let output = 'h2-2ar_1B title-1pmpPr size16-3IvaX_ height20-165WbF weightSemiBold-T8sxWH defaultColor-v22dK1 title-16MQon flexChild-1KGW5q';
        if (this.state.hover)
            output += ' titleHovered-1YMLyx';
        else
            output += ' titleNormal-3eHHbm';
        return output;
    }
    ...
    get iconClass() {
        ...
        if (this.state.hover)
            output += ' expandIconBGHovered-2C1DhE';
        else
            output += ' expandIconBGNormal-2Ve5cT';
        return output;
    }
            ...
            e('div', {},
                e('div', {
                    ...
                    e('div', {
                        ...
                        e('svg', {
                            className: `expandIcon-1EANE_ transition-2ebS5- ${this.state.expanded ? '' : 'closed-2Hef-I'}`,
