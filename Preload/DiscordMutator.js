...
Object.defineProperty(Discord.TextChannel.prototype, 'unread', {
    get: function () {
        ...
        return getReactInstance(this.element).memoizedProps.children.props.unread;
    }
});
    ...
    get: function () {
        ...
        for (const channel of channels) {
            ...
            if (react.memoizedProps.children[0]) {
                ...
                if (react.memoizedProps.children.props.channel.id === this.id) {
                    return channel;
                }
            }
        }
...
Object.defineProperty(Discord.Message.prototype, 'element', {
    get: function () {
        ...
        for (const message of messages) {
            ...
            if (!react) continue;
            let id = message.parentNode.parentNode.classList.contains('compact') ? react.memoizedProps.children[0].props.children[1].props.subscribeTo.split('_')[3] : react.memoizedProps.props.children[0].props.children[1].props.children[1].props.subscribeTo.split('_')[3];
