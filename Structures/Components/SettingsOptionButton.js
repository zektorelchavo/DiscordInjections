...
class SettingsButton extends window.DI.React.Component {
    get brandClass() {
    ...
    render() {
        return e('button', {
            className: this.props.outline ? this.outlineClass : this.brandClass, type: 'button',
            onClick: this.props.onClick,
            style: {
                flex: '0 1 auto'
            }
        },
            e('div', { className: this.props.outline ? this.outlineContentsClass : this.brandContentsClass },
                this.props.text));
    }
}
