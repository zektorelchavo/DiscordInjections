    ...
    try {
      switch (message.t) {
        case "READY":
          ...
          this.users.addArray(message.d.presences.map(p =>
          ...
          this.users.addArray(message.d.relationships.map(r =>
        ...
        */
        ...
        case "GUILD_SYNC":
          ...
          if (!g) {
            throw new Error("requested unkown guild")
          }
        ...
        case "GUILD_MEMBER_ADD":
          {
            ...
            if (!u) {
              if (!message.d.user.username) {
                throw new Error("GUILD_MEMBER_ADD: requested unkown user!")
              } else {
            ...
            if (message.d.guild_id) {
              ...
              if (!m) {
                if (!u) {
                  throw new Error("GUILD_MEMBER_ADD: requested unkown member!")
                }
        ...
        case "GUILD_MEMBER_UPDATE":
          {
            ...
            if (!u) {
              if (!message.d.user.username) {
                throw new Error("GUILD_MEMBER_UPDATE: requested unkown user!")
              } else {
                u = new User(this, message.d.user)
                this.users.add(u)
              }
        ...
        case "GUILD_MEMBER_REMOVE":
          {
            ...
            if (!u) {
              if (!message.d.user.username) {
                throw new Error("GUILD_MEMBER_REMOVE: requested unkown user!")
              } else {
                u = new User(this, message.d.user)
                this.users.add(u)
              }
