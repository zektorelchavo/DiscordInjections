...
module.exports = DI => {
  ...
  Object.defineProperty(Discord.TextChannel.prototype, "unread", {
    get: () => {
      ...
      return r._currentElement.props.children.props.unread
    }
  })
  ...
  Object.defineProperty(Discord.GuildChannel.prototype, "element", {
    get: () => {
      ...
      for (const channel of channels) {
        ...
        if (!r) continue
        if (r._currentElement.props.children[0]) {
          if (
            r._currentElement.props.children[0].props.channel.id === this.id
          ) {
            return channel
          }
        } else {
          if (r._currentElement.props.children.props.channel.id === this.id) {
            return channel
          }
        }
      }
    ...
    get: () => {
      ...
      for (const message of messages) {
        ...
        let id = message.parentNode.parentNode.classList.contains("compact")
          ? react._currentElement.props.children[0].props.children[1].props.subscribeTo.split(
              "_"
            )[3]
          : react._currentElement.props.children[0].props.children[1].props.children[1].props.subscribeTo.split(
              "_"
            )[3]
